...
(function() {
    ...
    */
    ...
    var loadChat = function(cb) {
        if (!cb) cb = function() {};
        $.get('https://rawgit.com/AdriseinGames/source/master/lang/langIndex.json', function(json) {
    ...
    var basicBot = {
        ...
        name: 'basicBot',
        loggedInID: null,
        scriptLink: 'https://rawgit.com/AdriseinGames/source/master/basicBot.js',
        cmdLink: 'http://git.io/245Ppg',
        chatLink: 'https://rawgit.com/AdriseinGames/source/master/lang/en.json',
        chat: null,
        loadChat: loadChat,
